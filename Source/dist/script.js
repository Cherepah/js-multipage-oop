...
window.addEventListener('DOMContentLoaded', function () {
  var sliderMain = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    btns: '.next'
  });
  sliderMain.render();
  var modulesSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.next',
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function checkMailInputs() {
      ...
      mailInputs.forEach(function (mailInput) {
